    ...
    <View style={styles.overlay}>
      ...
      <Animated.View style={[styles.sheet, sheetStyle]}>
        ...
        <TouchableOpacity
          ...
          disabled={!canSave}
        >
          <Svg width="18" height="18" viewBox="0 0 18 18" fill="none"><Circle cx="9" cy="9" r="5.5" stroke="white" strokeWidth="1.5" fill="none" /><Path d="M6 9L8 11L12 7" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></Svg>
...
const styles = StyleSheet.create({
  ...
  sheet: {
    ...
    maxHeight: '85%', shadowColor: '#000', shadowOffset: { width: 0, height: -8 }, shadowOpacity: 0.08, shadowRadius: 32, elevation: 12,
  },
  ...
  sheetSub: { fontSize: 13, color: '#94A3B8', lineHeight: 19, marginTop: 8, marginBottom: 8 },
  ...
  saveBtn: { height: 52, borderRadius: 16, backgroundColor: '#2E7D32', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8, shadowColor: '#2E7D32', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 20, elevation: 4 },
  saveBtnDisabled: { backgroundColor: '#E2E8F0', shadowOpacity: 0 },
