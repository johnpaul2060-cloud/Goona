...
function TabIcon({ i, active }: { i: number; active: boolean }) {
  ...
  return (
    <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      {i === 4 && <><Circle cx="6" cy="8" r="2" stroke={c} strokeWidth={w} fill="none" /><Circle cx="12" cy="8" r="2" stroke={c} strokeWidth={w} fill="none" /><Circle cx="18" cy="8" r="2" stroke={c} strokeWidth={w} fill="none" /><Path d="M3 17c0-1.8 1.5-3 3-3s3 1.2 3 3" stroke={c} strokeWidth={w} fill="none" strokeLinecap="round" /><Path d="M9 17c0-1.8 1.5-3 3-3s3 1.2 3 3" stroke={c} strokeWidth={w} fill="none" strokeLinecap="round" /><Path d="M15 17c0-1.8 1.5-3 3-3s3 1.2 3 3" stroke={c} strokeWidth={w} fill="none" strokeLinecap="round" /></>}
    </Svg>
  )
}
